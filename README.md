<div align="center">
  <img src="thumbnails/blendkit_logo.png" alt="Logo" width="100" height="100"/>
  <h3 align="center">Blendkit</h3>
...
## About
The Blendkit add-on, an official and free open-source extension for Blender 3D, connects users to the [Blendkit service](https://www.blenderkit.com/), allowing you to search, download, upload and rate a vast array of assets.
...
## Get started
1. Download the add-on from the [Blendkit website](https://www.blenderkit.com/get-blenderkit/).
2. Install the .zip file in Blender's `Preferences > Add-ons > Install`, and enable it.
3. Open the Blendkit panel in the 3D Viewport, type what you need, choose the asset you like and drag and drop it into the scene.
4. Enjoy!
...
- [Become a Creator](https://www.blenderkit.com/become-creator/) and upload your assets to Blendkit into Free or Full Plan database,
