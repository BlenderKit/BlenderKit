...
class TestAssetBarResizeHelpers(unittest.TestCase):
    ...
    def test_update_scroll_button_icons_uses_horizontal_icons_for_single_row(self):
        button_scroll_down = SimpleNamespace(
            text="?",
            set_image=Mock(),
            set_image_size=Mock(),
            set_image_position=Mock(),
        )
        button_scroll_up = SimpleNamespace(
            text="?",
            set_image=Mock(),
            set_image_size=Mock(),
            set_image_position=Mock(),
        ...
        with patch.object(
            asset_bar_op.paths,
            "get_addon_thumbnail_path",
            side_effect=lambda name: f"/icons/{name}",
        ):
            asset_bar_op.BlenderKitAssetBarOperator.update_scroll_button_icons(dummy)

        button_scroll_down.set_image.assert_called_once_with("/icons/arrow_left.png")
        button_scroll_up.set_image.assert_called_once_with("/icons/arrow_right.png")
        button_scroll_down.set_image_size.assert_called_once_with((30, 96))
        button_scroll_up.set_image_size.assert_called_once_with((30, 96))
        button_scroll_down.set_image_position.assert_called_once_with((0, 42))
        button_scroll_up.set_image_position.assert_called_once_with((0, 42))
        self.assertEqual(button_scroll_down.text, "")
        self.assertEqual(button_scroll_up.text, "")

    def test_update_scroll_button_icons_uses_vertical_arrows_for_multi_row(self):
        button_scroll_down = SimpleNamespace(
            text="?",
            set_image=Mock(),
            set_image_size=Mock(),
        ...
        button_scroll_down.set_image.assert_called_once_with("/icons/arrow_up.png")
        button_scroll_up.set_image.assert_called_once_with("/icons/arrow_down.png")
        button_scroll_down.set_image_size.assert_called_once_with((21, 96))
        button_scroll_up.set_image_size.assert_called_once_with((21, 96))
        button_scroll_down.set_image_position.assert_called_once_with((4, 42))
        button_scroll_up.set_image_position.assert_called_once_with((4, 42))
        self.assertEqual(button_scroll_down.text, "")
        self.assertEqual(button_scroll_up.text, "")
    ...
    def test_update_assetbar_layout_positions_resize_edge_strip_and_toggle_button(self):
        dummy = SimpleNamespace(
            ...
            update_scroll_button_icons=Mock(),
        )
        ...
        dummy.update_scroll_button_icons.assert_called_once_with()
